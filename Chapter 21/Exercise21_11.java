...
public class Exercise21_11 extends Application {
  ...
  String basURL = "http://liveexample.pearsoncmg.com/data/babynamesranking2001.txt,http://liveexample.pearsoncmg.com/data/babynamesranking2010.txt";
  String[]urls = new String[10];
  String[]year = new String[urls.length];
  
  babyNameMapsArray = (HashMap<String, Integer>[][])new HashMap[2][urls.length];
